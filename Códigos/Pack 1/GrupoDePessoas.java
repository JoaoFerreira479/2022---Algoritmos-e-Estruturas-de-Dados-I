...
public class GrupoDePessoas {
        ...
        try {
            ...
            while (true) {
                ...
                if (!validarIdade(idade)) {
                    exibirMensagem("Idade inválida! Digite uma idade maior ou igual a 0, ou " + ENCERRAR + " para encerrar.");
                    continue;
                }
    ...
    private static void exibirResultados(int quantidadeHomens, int quantidadeMulheres, int somaIdadesHomens, int totalPessoas, int maiorIdade, int menorIdade) {
